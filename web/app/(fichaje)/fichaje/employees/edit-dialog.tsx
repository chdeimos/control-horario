                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <Tabs defaultValue="general" className="w-full">
                        <TabsList className="w-full justify-start rounded-none border-b bg-transparent px-6 h-12">
                            <TabsTrigger value="general" className="data-[state=active]:bg-transparent data-[state=active]:border-b-2 data-[state=active]:border-[#3b60c1] rounded-none h-12 gap-2">
                                <User className="h-4 w-4" />
                                Datos Generales
                            </TabsTrigger>
                            <TabsTrigger value="schedule" className="data-[state=active]:bg-transparent data-[state=active]:border-b-2 data-[state=active]:border-[#3b60c1] rounded-none h-12 gap-2">
                                ...
                                <div className="grid grid-cols-3 gap-4 border-t pt-4">
                                    <div className="grid gap-2">
                                        ...
                                        <Input
                                            ...
                                            className="font-bold text-[#3b60c1] bg-blue-50/20"
                                        />
                                    </div>
                                    <div className="grid gap-2">
